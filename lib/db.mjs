...
/** Clientes ativos, para o seletor do painel e para os crons multi-cliente. */
export async function listClients() {
  return sql`SELECT id, name, domain, gsc_property, monthly_budget_usd,
                    publish_adapter, adapter_config, created_at
               FROM clients WHERE is_active ORDER BY created_at ASC`;
}
